...
SECRET_KEY = 'django-insecure-zre$%tlw2-=kdi$)f@fe@w=++5=wz%(4f8mzgq5%n1q)2r!ufc'
...
if env('DATABASE_URL', default=None):
    ...
    DATABASES['default']['OPTIONS'] = {'options': '-c search_path=reporting_service,public'}
else:
    DATABASES = {
        'default': {
...
import os
OTEL_SERVICE_NAME = os.environ.get('OTEL_SERVICE_NAME', 'reporting-service')
